...
--rida 576
--- 5tund
alter proc spGeyEmployeesByGenderAndDepartment
@Gender nvarchar(20),
@DepartmentId int
with encryption
as begin
...
create proc spGetEmloyeeCountByGender
@Gender nvarchar(20),
...
execute spGetEmloyeeCountByGender 'Male', @TotalCount out
if(@TotalCount = 0)
...
declare @TotalCount int
execute spGetEmloyeeCountByGender @EmployeeCount = @TotalCount out, @Gender = 'Male'
print @TotalCount

-- sp sisu vaatamine
sp_help spGetEmloyeeCountByGender
-- tabeli info
sp_help Employees
-- kui soovid sp teksti näha
sp_helptext spGetEmloyeeCountByGender

-- vaatame, millest see sp sõltub
sp_depends spGetEmloyeeCountByGender
-- vaatame tabelit
...
declare  @FirstName nvarchar(50)
execute @FirstName = spGetNameById2 2
print 'Name of the employee = ' + @FirstName
-- Ei saa konvertida nvarchar type to int
...
-- reverse funktsiooni pöörab kõik ümber
...
select FirstName, ltrim(rtrim(len(FirstName))) as [Total Characters] from Employees
...
select  FirstName, LastName,
	substring(Email, 1, 2) + replicate('*', 5) + -- peale teist tähemärki viis tärni
