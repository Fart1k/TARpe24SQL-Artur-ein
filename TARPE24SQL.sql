...
-- näitab ära osakonnad, kus töötajaid on 2tk või rohkem
...
-- sarnane päritud tabelile a ei ole salvestatud objektina
...
-- kasutame Employees_Name_Gender
-- muudame Id ühe all oleva isiku sugu Female
with Employees_Name_Gender
as
(
	select Id, Name, Gender from Employee
...
update EmployeesByDepartment set Gender = 'Female', DepartmentName = 'HR' 
where Id = 1
...
-- muudame DepartmentId veerg ManagerId nimeks
